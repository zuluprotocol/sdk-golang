...
var file_vega_events_v1_events_proto_rawDesc = []byte{
	...
	0x22, 0xaa, 0x03, 0x0a, 0x0c, 0x53, 0x74, 0x61, 0x6b, 0x65, 0x4c, 0x69, 0x6e, 0x6b, 0x69, 0x6e,
	...
	0x55, 0x53, 0x5f, 0x52, 0x45, 0x4a, 0x45, 0x43, 0x54, 0x45, 0x44, 0x10, 0x03, 0x22, 0x67, 0x0a,
	...
	0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0xc9, 0x01, 0x0a, 0x11, 0x52, 0x65, 0x77, 0x61, 0x72,
	...
	0x6d, 0x70, 0x22, 0x9f, 0x01, 0x0a, 0x13, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72,
	...
	0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0xae, 0x07, 0x0a, 0x0c, 0x54, 0x78, 0x45,
	...
	0x53, 0x75, 0x62, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x4e, 0x0a, 0x10, 0x72, 0x65,
	0x73, 0x74, 0x6f, 0x72, 0x65, 0x5f, 0x73, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x18, 0x6e,
	...
	0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x48, 0x00, 0x52, 0x0f, 0x72, 0x65, 0x73, 0x74, 0x6f,
	0x72, 0x65, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x42, 0x0d, 0x0a, 0x0b, 0x74, 0x72,
	...
	0x01, 0x28, 0x03, 0x52, 0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x49, 0x0a, 0x11,
	...
	0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x22, 0xfd, 0x01, 0x0a, 0x0f, 0x56, 0x61, 0x6c, 0x69,
	...
	0x61, 0x74, 0x61, 0x72, 0x55, 0x72, 0x6c, 0x22, 0xb7, 0x12, 0x0a, 0x08, 0x42, 0x75, 0x73, 0x45,
	...
	0x69, 0x6e, 0x74, 0x12, 0x36, 0x0a, 0x06, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x18, 0xe9, 0x07,
	...
	0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x42, 0x07, 0x0a, 0x05, 0x65, 0x76, 0x65, 0x6e,
	0x74, 0x2a, 0xe3, 0x09, 0x0a, 0x0c, 0x42, 0x75, 0x73, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79,
	...
	0x45, 0x5f, 0x43, 0x48, 0x45, 0x43, 0x4b, 0x50, 0x4f, 0x49, 0x4e, 0x54, 0x10, 0x23, 0x12, 0x19,
	...
	0x52, 0x52, 0x4f, 0x52, 0x10, 0xc9, 0x01, 0x42, 0x30, 0x5a, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x2e,
...
var file_vega_events_v1_events_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_vega_events_v1_events_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_vega_events_v1_events_proto_goTypes = []interface{}{
	...
	(*v1.DelegateSubmission)(nil),           // 29: vega.commands.v1.DelegateSubmission
	(*v1.UndelegateSubmission)(nil),         // 30: vega.commands.v1.UndelegateSubmission
	(*v1.RestoreSnapshot)(nil),              // 31: vega.commands.v1.RestoreSnapshot
	(vega.EpochAction)(0),                   // 32: vega.EpochAction
	(*vega.TransferResponse)(nil),           // 33: vega.TransferResponse
	(vega.AuctionTrigger)(0),                // 34: vega.AuctionTrigger
	(*vega.Order)(nil),                      // 35: vega.Order
	(*vega.Account)(nil),                    // 36: vega.Account
	(*vega.Party)(nil),                      // 37: vega.Party
	(*vega.Trade)(nil),                      // 38: vega.Trade
	(*vega.MarginLevels)(nil),               // 39: vega.MarginLevels
	(*vega.Proposal)(nil),                   // 40: vega.Proposal
	(*vega.Vote)(nil),                       // 41: vega.Vote
	(*vega.MarketData)(nil),                 // 42: vega.MarketData
	(*v1.NodeSignature)(nil),                // 43: vega.commands.v1.NodeSignature
	(*vega.Market)(nil),                     // 44: vega.Market
	(*vega.Asset)(nil),                      // 45: vega.Asset
	(*vega.Withdrawal)(nil),                 // 46: vega.Withdrawal
	(*vega.Deposit)(nil),                    // 47: vega.Deposit
	(*vega.RiskFactor)(nil),                 // 48: vega.RiskFactor
	(*vega.NetworkParameter)(nil),           // 49: vega.NetworkParameter
	(*vega.LiquidityProvision)(nil),         // 50: vega.LiquidityProvision
...
var file_vega_events_v1_events_proto_depIdxs = []int32{
	...
	29, // 9: vega.events.v1.TxErrorEvent.delegate_submission:type_name -> vega.commands.v1.DelegateSubmission
	30, // 10: vega.events.v1.TxErrorEvent.undelegate_submission:type_name -> vega.commands.v1.UndelegateSubmission
	31, // 11: vega.events.v1.TxErrorEvent.restore_snapshot:type_name -> vega.commands.v1.RestoreSnapshot
	32, // 12: vega.events.v1.EpochEvent.action:type_name -> vega.EpochAction
	33, // 13: vega.events.v1.TransferResponses.responses:type_name -> vega.TransferResponse
	15, // 14: vega.events.v1.SettlePosition.trade_settlements:type_name -> vega.events.v1.TradeSettlement
	34, // 15: vega.events.v1.AuctionEvent.trigger:type_name -> vega.AuctionTrigger
	34, // 16: vega.events.v1.AuctionEvent.extension_trigger:type_name -> vega.AuctionTrigger
	0,  // 17: vega.events.v1.BusEvent.type:type_name -> vega.events.v1.BusEventType
	10, // 18: vega.events.v1.BusEvent.time_update:type_name -> vega.events.v1.TimeUpdate
	12, // 19: vega.events.v1.BusEvent.transfer_responses:type_name -> vega.events.v1.TransferResponses
	13, // 20: vega.events.v1.BusEvent.position_resolution:type_name -> vega.events.v1.PositionResolution
	35, // 21: vega.events.v1.BusEvent.order:type_name -> vega.Order
	36, // 22: vega.events.v1.BusEvent.account:type_name -> vega.Account
	37, // 23: vega.events.v1.BusEvent.party:type_name -> vega.Party
	38, // 24: vega.events.v1.BusEvent.trade:type_name -> vega.Trade
	39, // 25: vega.events.v1.BusEvent.margin_levels:type_name -> vega.MarginLevels
	40, // 26: vega.events.v1.BusEvent.proposal:type_name -> vega.Proposal
	41, // 27: vega.events.v1.BusEvent.vote:type_name -> vega.Vote
	42, // 28: vega.events.v1.BusEvent.market_data:type_name -> vega.MarketData
	43, // 29: vega.events.v1.BusEvent.node_signature:type_name -> vega.commands.v1.NodeSignature
	14, // 30: vega.events.v1.BusEvent.loss_socialization:type_name -> vega.events.v1.LossSocialization
	16, // 31: vega.events.v1.BusEvent.settle_position:type_name -> vega.events.v1.SettlePosition
	17, // 32: vega.events.v1.BusEvent.settle_distressed:type_name -> vega.events.v1.SettleDistressed
	44, // 33: vega.events.v1.BusEvent.market_created:type_name -> vega.Market
	45, // 34: vega.events.v1.BusEvent.asset:type_name -> vega.Asset
	18, // 35: vega.events.v1.BusEvent.market_tick:type_name -> vega.events.v1.MarketTick
	46, // 36: vega.events.v1.BusEvent.withdrawal:type_name -> vega.Withdrawal
	47, // 37: vega.events.v1.BusEvent.deposit:type_name -> vega.Deposit
	19, // 38: vega.events.v1.BusEvent.auction:type_name -> vega.events.v1.AuctionEvent
	48, // 39: vega.events.v1.BusEvent.risk_factor:type_name -> vega.RiskFactor
	49, // 40: vega.events.v1.BusEvent.network_parameter:type_name -> vega.NetworkParameter
	50, // 41: vega.events.v1.BusEvent.liquidity_provision:type_name -> vega.LiquidityProvision
	44, // 42: vega.events.v1.BusEvent.market_updated:type_name -> vega.Market
	51, // 43: vega.events.v1.BusEvent.oracle_spec:type_name -> oracles.v1.OracleSpec
	52, // 44: vega.events.v1.BusEvent.oracle_data:type_name -> oracles.v1.OracleData
	7,  // 45: vega.events.v1.BusEvent.delegation_balance:type_name -> vega.events.v1.DelegationBalanceEvent
	6,  // 46: vega.events.v1.BusEvent.validator_score:type_name -> vega.events.v1.ValidatorScoreEvent
	11, // 47: vega.events.v1.BusEvent.epoch_event:type_name -> vega.events.v1.EpochEvent
	20, // 48: vega.events.v1.BusEvent.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	3,  // 49: vega.events.v1.BusEvent.stake_linking:type_name -> vega.events.v1.StakeLinking
	5,  // 50: vega.events.v1.BusEvent.reward_payout:type_name -> vega.events.v1.RewardPayoutEvent
	4,  // 51: vega.events.v1.BusEvent.checkpoint:type_name -> vega.events.v1.CheckpointEvent
	8,  // 52: vega.events.v1.BusEvent.market:type_name -> vega.events.v1.MarketEvent
	9,  // 53: vega.events.v1.BusEvent.tx_err_event:type_name -> vega.events.v1.TxErrorEvent
